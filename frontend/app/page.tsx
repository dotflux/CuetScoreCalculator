    ...
    <div className="min-h-screen relative bg-neutral-50 dark:bg-black text-neutral-900 dark:text-neutral-50 transition-colors duration-200">
      <div className="absolute top-6 right-6 z-50 flex items-center gap-3">
        ...
        <button
          type="button"
          onClick={toggleTheme}
          className="p-2 border border-neutral-300 dark:border-neutral-800 rounded-xl text-neutral-600 dark:text-neutral-300 hover:text-neutral-950 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-all cursor-pointer"
